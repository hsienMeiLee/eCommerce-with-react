        ...
        <div className='container'>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl' style={{backgroundColor : data.bgColor}}>
                ...
                <div className='p-6 sm:p-8'>
                    <p data-aos="slight-right" className='text-sm'>{data.discount}</p>
                ...
                <div data-aos="zoom-in" className='w-full flex items-center'>
                    <img src={data.image} alt="image" className='scale-150 w-[250px] md:w-[340px] mx-auto drop-shadow-2xl object-cover' />
                </div>
                {/* third col */}
                <div className='flex flex-col justify-center gap-4 p-6 sm:p-8'>
                    ...
                    <p data-aos="fade-up" data-aos-offset="0" className='text-sm tracking-wide leading-5'>{data.title4}</p>
                    <div>
                        <button style={{color : data.bgColor}} className=' bg-white px-4 py-2 rounded'>Shop Now</button>
                    </div>
                </div>
            </div>
        </div>
